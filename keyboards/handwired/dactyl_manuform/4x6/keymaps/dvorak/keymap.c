...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LAYER_0] = LAYOUT(
        ...
        KC_CAPS, KC_A,    LA_O,    LC_E,    LG_U,    L1_I,               L1_D,    RG_H,    RC_T,    RA_N,    KC_S,    KC_MINS,
    ...
    [_LAYER_1] = LAYOUT(
        ...
        KC_LEAD, KC_QUES, KC_LEFT, KC_DOWN, KC_RGHT, KC_EXLM,             KC_EQL,  KC_4,    KC_5,    KC_6,    KC_PPLS, KC_PMNS,
